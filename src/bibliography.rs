...
impl Bibliography {
    ...
    pub fn sort(&self) -> Option<crate::Sort> {
        self.0.sort.clone().map(|x| x.into())
    }
    #[wasm_bindgen(setter)]
    ...
    pub fn second_field_align(&self) -> Option<crate::SecondFieldAlign> {
        self.0.second_field_align.clone().map(|x| x.into())
    }
    #[wasm_bindgen(setter)]
    pub fn set_second_field_align(&mut self, v: Option<crate::SecondFieldAlign>) {
        self.0.second_field_align = v.map(|x| x.into());
    }
    #[wasm_bindgen(getter)]
    ...
    pub fn set_line_spacing(&mut self, v: i16) {
        self.0.line_spacing = std::num::NonZeroI16::new(v).unwrap_throw();
    }
    #[wasm_bindgen(getter)]
